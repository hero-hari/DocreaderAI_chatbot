...
const GoogleLoginButton = ({ isLoading }) => {
  ...
  useEffect(() => {
        ...
        if (buttonRef.current) {
          try {
            ...
            window.google.accounts.id.renderButton(buttonRef.current, {
              ...
              text: 'signin_with',
              shape: 'rounded',
              width: isMobile ? 260 : 280  // ✅ Smaller on mobile
            });
          } catch (error) {
    ...
    checkGoogleLoaded();
    const interval = setInterval(checkGoogleLoaded, 500);
      ...
      {googleLoaded ? (
        ...
        <div className="text-center w-full px-4">
          <button
            ...
            disabled={isLoading}
            className="w-full max-w-[280px] px-4 md:px-6 py-3 
